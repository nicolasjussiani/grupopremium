...
class FullSiteRouteTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.colaborador = Colaborador.objects.create(
            ...
            anexo_cpf='testes/cpf-colaborador.pdf',
        )
    ...
    def test_todas_as_paginas_e_endpoints_get(self):
        expected_routes = (
            ...
            ('painel_sla', (), 200),
            ('arquivo_central', (), 200),
            ('detalhe_arquivo_importado', (self.arquivo_importado.pk,), 200),
            ...
            ('baixar_anexo_colaborador', (self.colaborador.pk, 'anexo_cpf'), 302),
            ...
            ('painel_fiscal', (), 200),
            ('exportar_lotes_fiscal_xlsx', (), 200),
            ('exportar_folha_fiscal_xlsx', (self.folha_fiscal.pk,), 200),
